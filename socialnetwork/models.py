...
# ---------------------------------------------------------------------------
# TASK T4 — Data Model Adaption to keep track of a user’s communities
# ---------------------------------------------------------------------------
class SocialNetworkUsers(FameUsers):
    ...
    # 'communities' is a many-to-many relationship between SocialNetworkUsers and ExpertiseAreas.
    # blank=True allows a user to have no community memberships.
    communities = models.ManyToManyField(ExpertiseAreas, blank=True)
